<template>
  <div class="h-100 overflow-hidden">
    ...
    <section class="bg-white border border-top-0 my">
      <Tabs />
      <form @submit.prevent="submitForm" class="bg-white h-100 p-3 pb-0  mt-2">
        ...
        <div :class="{invisible: !getAuthState('err')}" class="alert-danger alert d-flex flex-row-reverse justify-content-between align-items-center py-1 my-2">
          <button @click="closeAuthErr()" class="btn-close align-self-end py-2" type="button" aria-label="Close"></button>
